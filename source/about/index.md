---
title: about
date: 2021-11-13 17:29:14
about: true
toc: true
highlight_shrink: true
---
> hexo框架、butterfly主题搭建的个人主页，稍作修改，内容如下
> 技术支持：
> * [框架hexo](https://hexo.io/zh-tw/)
> * [主题butterfly](https://github.com/jerryc127/hexo-theme-butterfly) 

> 目录
<!-- TOC -->
- [v.1.0修改文件](#v-1-0修改文件)
	- [_config.yml](#config-yml-v-1-0)
	- [link.yml](#link-yml-v-1-0)
	- [_config.yml(theme)](#config-yml-theme-v-1-0)
	- [var.styl](#var-styl-v-1-0)
	- [common.styl](#common-styl-v-1-0)
	- [homepage.styl](#homepage-styl-v-1-0)
	- [index.pug](#index-pug-v-1-0)
	- [main.js](#main-js-v-1-0)
	- [additional-js.pug](#additional-js-pug-v-1-0)
<!-- TOC -->

## v.1.0修改文件

| Key                                                             | Type   | Src                                                       | Description                                                                       |
| --------------------------------------------------------------- | ------ | --------------------------------------------------------- | --------------------------------------------------------------------------------- |
| [_config.yml](#config-yml-v-1-0)                                | yml    | /                                                         | hexo config                                                                       |
| [link.yml](#link-yml-v-1-0)                                     | yml    | /source/_data/link.yml                                    | friend links                                                                      |
| [_config.yml](#config-yml-theme-v-1-0)                          | yml    | /themes/butterfly/_config.yml                             | butterfly theme config                                                            |
| [var.styl](#var-styl-v-1-0)                                     | css    | /themes/butterfly/source/css/var.styl                     | css constant                                                                      |
| [common.styl](#common-styl-v-1-0)                               | css    | /themes/butterfly/source/css/_page/common.styl            | post width                                                                        |
| [homepage.styl](#homepage-styl-v-1-0)                           | css    | /themes/butterfly/source/css/_page/homepage.styl          | home post label height                                                            |
| [index.pug](#index-pug-v-1-0)                                   | pug    | /themes/butterfly/layout/includes/widget/index.pug        | post add categories label and move home page categories label on aside list's top |
| [main.js](#main-js-v-1-0)                                       | js     | /themes/butterfly/source/js/main.js                       | post toc can click to focus toc log error                                         |
| [additional-js.pug](#additional-js-pug-v-1-0)                   | pug    | /themes/butterfly/layout/includes/additional-js.pug       | preload jquery js                                                                 |
...
- class_name: 友情链接
  ...
  link_list:
    - name: Hexo
      ...
      descr: 快速、简单且强大的hexo框架
    - name: huaxianyi
      link: https://www.huaxianyi.com
...
# Favicon（網站圖標）
favicon: http://42.192.149.99:9000/blog/hexo/black.jpg

# Avatar (頭像)
avatar:
  img: http://42.192.149.99:9000/blog/hexo/black.jpg
  effect: false
...
index_img: http://42.192.149.99:9000/blog/hexo/black.jpg

# If the banner of page not setting, it will show the top_img
default_top_img: http://42.192.149.99:9000/blog/hexo/black.jpg

# The banner image of archive page
archive_img: http://42.192.149.99:9000/blog/hexo/black.jpg

# If the banner of tag page not setting, it will show the top_img
# note: tag page, not tags page (子標籤頁面的 top_img)
tag_img: http://42.192.149.99:9000/blog/hexo/black.jpg

# The banner image of tag page
# format:
#  - tag name: xxxxx
tag_per_img: http://42.192.149.99:9000/blog/hexo/black.jpg

# If the banner of category page not setting, it will show the top_img
# note: category page, not categories page (子分類頁面的 top_img)
category_img: http://42.192.149.99:9000/blog/hexo/black.jpg

# The banner image of category page
# format:
#  - category name: xxxxx
category_per_img: http://42.192.149.99:9000/blog/hexo/black.jpg
...
post_meta:
  ...
  post:
    ...
    date_format: date # date/relative 顯示日期還是相對日期
    categories: true # false or false 文章頁是否顯示分類
...
background: url(http://42.192.149.99:9000/blog/hexo/black.jpg)
...
### var.styl(v.1.0)
``` properties
$layout-post-width = hexo-config('theme_layout.post_width')px
$layout-home-kp-height = hexo-config('theme_layout.home_kp_height')em
```
### common.styl(v.1.0)
``` css
.layout
...
### main.js(v.1.0)
``` js
//post toc can click to focus
$("a.headerlink").each(function () {
    let a = $(this)
    let parent = $(this).parent()
    let a_text = $(this).parent().text();
    parent.text('')
    a.text(a_text)
    parent.html(a)
})
...
for (; parent.matches !== undefined && !parent.matches('.toc'); parent = parent.parentNode) {
if (parent.matches('li')) parent.classList.add('active')
}
```
### additional-js.pug(v.1.0)
``` html
div
